...
import { Mail, Lock, User, ArrowLeft, Sun, Moon } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-4">
      ...
      >
        <div className="text-center mb-8">
          <div className="inline-flex w-12 h-12 bg-primary rounded-xl items-center justify-center text-white font-bold text-2xl mb-4">W</div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button 
              ...
              onClick={() => {
                setIsLoading(true);
                setTimeout(() => {
                  login('demo@worksphere.com', 'password');
                  navigate('/dashboard');
                }, 1000);
              }}
            >
    ...
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Join WorkSphere and transform your HR management</p>
        </div>
        ...
        <Card className="p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-4">
              <div className="relative">
                <User className="absolute left-3 top-9 text-muted-foreground" size={18} />
                <Input 
                  label="Full Name" 
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button 
              ...
              onClick={() => {
                setIsLoading(true);
                setTimeout(() => {
                  register('Demo User', 'demo@worksphere.com', 'password');
                  navigate('/dashboard');
                }, 1000);
              }}
            >
